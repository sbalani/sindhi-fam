-- Match detailed partner creation to canonical person limits and bound each
-- graph-locking request before it can insert any rows.
...
begin
  ...
  if jsonb_typeof(p_connections)<>'object'
    ...
    or jsonb_array_length(coalesce(p_connections->'partners','[]'::jsonb))>50 then
