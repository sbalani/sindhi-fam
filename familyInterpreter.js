...
const TOKENS = {
  ...
  sd: {
    ...
    grandfather: 'ڏاڏو|نانا|dado|dada|nana', grandmother: 'ڏاڏي|ناني|dadi|nani', uncle: 'چاچو|مامو|chacha|mama', aunt: 'چاچي|مامي|chachi|mami|maasi|aunt|aunty',
  },
}
...
const extractNameAndFacts = (rest, language) => {
  ...
  if (language === 'es') {
    ...
    value = value.replace(/^(?:(?:جو|جي)\s+نالو\s+|نالو\s+)?(?:آهي|هو|هئي|is\s+called|was\s+called|called|named|is|was|aahe|ahe)?\s*/iu, '')
  } else {
